'''
    Created by Harshit Verma 2020
    This is the instagram bot to open hashtags and follow, like and comment on the post
    Requirement - selenium and chrome
'''
...
import pandas as pd
print(1)
chromedriver_path = 'C:\\Users\\hp\\Desktop\\chromedriver.exe' # Change this to your own chromedriver path!
...
username.send_keys('mentalhealth885')
password = webdriver.find_element_by_name('password')
password.send_keys('elonmusk')
...
logininfo = webdriver.find_element_by_css_selector('#react-root > section > main > div > div > div > div > button')
logininfo.click()
